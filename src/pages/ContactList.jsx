        ...
        <div className="bg-primary px-4 py-8 text-white min-h-screen overflow-x-hidden">
            <div className="mx-auto flex w-full max-w-5xl flex-col items-center gap-6">
                <div className="group text-center">
                    <h1 className="text-3xl underline group-hover:scale-110 transition-transform duration-1000 font-bold">
                        Contacts Management
                    </h1>
                    <p className="group-hover:scale-110 transition-transform duration-1000">
                ...
                {store.listContacts.length === 0 && (
                    <div className="w-full rounded-lg border border-white/50 bg-white/30 p-8 text-center">
                        ...
                        <p className="text-sm text-gray-200">Use the Add Contact button in the header.</p>
                    </div>
                )}
